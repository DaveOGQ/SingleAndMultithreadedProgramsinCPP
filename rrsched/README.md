...
In this project the actual process data is being manipulated in the deque to prevent repeatedly copying data and thereby effectively speeding up the program.
